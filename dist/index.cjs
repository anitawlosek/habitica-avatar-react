...
var ClassBadge = ({ memberClass, badgeSize = 32, className = "" }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    "div",
    {
      className: `${ClassBadge_module_default["class-badge"]}${className ? " " + className : ""}`,
      style: { ["--badge-size"]: badgeSize + "px" },
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "div",
        {
          className: ClassBadge_module_default["svg-icon"],
...
var HabiticaAvatar = ({
  ...
  const showBackground = (0, import_react3.useMemo)(() => !gearOnly && !avatarOnly || withBackground, [gearOnly, avatarOnly, withBackground]);
  ...
  const topLevelClassList = (0, import_react3.useMemo)(() => {
    const classes = [];
    if (debugMode) classes.push(HabiticaAvatar_module_default.debug);
    if (centerAvatar) classes.push(HabiticaAvatar_module_default["centered-avatar"]);
  ...
  const specialMountClass = (0, import_react3.useMemo)(() => {
    if (!avatarOnly && member.items.currentMount && member.items.currentMount.includes("Kangaroo")) {
      return HabiticaAvatar_module_default["offset-kangaroo"];
    }
    return "";
  }, [avatarOnly, member]);
  const handleClick = (e) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    ...
    {
      className: createClassName(HabiticaAvatar_module_default.avatar, topLevelClassList),
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: HabiticaAvatar_module_default["character-sprites"], style: { margin: spritesMargin }, children: [
          !avatarOnly && !gearOnly && member.items.currentMount && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["mount.body"] }),
          !gearOnly && avatarSpritesDetails.buff && showVisualBuffs ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.buff }) : null,
          !gearOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["hair.flower"] }),
          showAvatar && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
            !gearOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.chair, className: specialMountClass }),
            ...
            !gearOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.skin, className: specialMountClass }),
            !gearOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.shirt, className: specialMountClass }),
            !gearOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.head_0, className: specialMountClass }),
            ...
            !gearOnly && ["bangs", "base", "mustache", "beard"].map((type) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails[`hair.${type}`], className: specialMountClass }, type)),
            ...
            !gearOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["hair.flower"], className: specialMountClass }),
            ...
            !hideGear("weapon") && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["gear.weapon"], className: createClassName(specialMountClass, HabiticaAvatar_module_default.weapon) })
          ] }),
          !gearOnly && member.preferences.sleep && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["sleep"] }),
          !avatarOnly && !gearOnly && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.pet, className: HabiticaAvatar_module_default["current-pet"] })
          ] })
        ] }),
        isDefined(member.stats.class) && showClassBadge && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ClassBadge_default, { className: ClassBadge_module_default["under-avatar"], memberClass: member.stats.class })
      ] })
    }
  );
};
