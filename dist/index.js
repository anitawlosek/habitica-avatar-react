...
import { useMemo, useEffect as useEffect3, useState as useState2, useCallback } from "react";
...
// src/components/HabiticaAvatar/HabiticaAvatar.tsx
import { getHabiticaAvatarItemsDetail, getHabiticaImagesMeta } from "habitica-avatar-manifest";
...
var HabiticaAvatar = ({
  ...
  const [staticData, setStaticData] = useState2({ imagesMeta: null, avatarItemsDetails: null });
  useEffect3(() => {
