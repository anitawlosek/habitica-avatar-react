...
var HabiticaAvatar = ({
  ...
  const showBackground = useMemo2(() => !gearOnly && !avatarOnly || withBackground, [gearOnly, avatarOnly, withBackground]);
  ...
  return /* @__PURE__ */ jsx3(
    HabiticaSprite_default,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("div", { className: HabiticaAvatar_module_default["character-sprites"], style: { margin: spritesMargin }, children: [
          !avatarOnly && !gearOnly && member.items.currentMount && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["mount.body"] }),
          !gearOnly && avatarSpritesDetails.buff && showVisualBuffs ? /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.buff }) : null,
          !gearOnly && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["hair.flower"] }),
          showAvatar && /* @__PURE__ */ jsxs(Fragment, { children: [
            !gearOnly && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.chair, className: specialMountClass }),
            /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["gear.back"], className: specialMountClass }),
            !gearOnly && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.skin, className: specialMountClass }),
            !gearOnly && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.shirt, className: specialMountClass }),
            !gearOnly && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.head_0, className: specialMountClass }),
            ...
            !gearOnly && ["bangs", "base", "mustache", "beard"].map((type) => /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails[`hair.${type}`], className: specialMountClass }, type)),
            ...
            !gearOnly && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["hair.flower"], className: specialMountClass }),
            ...
            !hideGear("weapon") && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["gear.weapon"], className: createClassName(specialMountClass, HabiticaAvatar_module_default.weapon) })
          ] }),
          !gearOnly && member.preferences.sleep && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails["sleep"] }),
          !avatarOnly && !gearOnly && /* @__PURE__ */ jsxs(Fragment, { children: [
            member.items.currentMount && /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails[`mount.head`] }),
            /* @__PURE__ */ jsx3(HabiticaSprite_default, { spriteDetails: avatarSpritesDetails.pet, className: HabiticaAvatar_module_default["current-pet"] })
          ] })
        ] }),
        isDefined(member.stats.class) && showClassBadge && /* @__PURE__ */ jsx3(ClassBadge_default, { className: ClassBadge_module_default["under-avatar"], memberClass: member.stats.class })
      ] })
    }
  );
};
